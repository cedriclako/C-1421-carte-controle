...
static const PFL_SParameterItem m_sParameterItems[] =
{
	...
	PFL_INIT_SINT32(PFD_OPEN_VSLOW,			 	"", &m_sMemBlock.s32VslowOpen,		 				   		300, 0, 100),
	PFL_INIT_SINT32(PFD_OPEN_SLOW,			 	"", &m_sMemBlock.s32SlowOpen,		 				   		150, 0, 100),
	PFL_INIT_SINT32(PFD_OPEN_AVG,			 	"", &m_sMemBlock.s32AvgOpen,		 				   		100, 0, 100),
	PFL_INIT_SINT32(PFD_OPEN_FAST,			 	"", &m_sMemBlock.s32FastOpen,		 				   		60, 0, 100),
	PFL_INIT_SINT32(PFD_CLOSE_VSLOW,			"", &m_sMemBlock.s32VslowClose,		 				   		350, 0, 100),
	PFL_INIT_SINT32(PFD_CLOSE_SLOW,			 	"", &m_sMemBlock.s32SlowClose,		 				   		180, 0, 100),
	PFL_INIT_SINT32(PFD_CLOSE_AVG,			 	"", &m_sMemBlock.s32AvgClose,		 				   		120, 0, 100),
	PFL_INIT_SINT32(PFD_CLOSE_AVG,			 	"", &m_sMemBlock.s32FastClose,		 				   		80, 0, 100),
	...
	PFL_INIT_SINT32(PFD_MAJ_CORR,			 	"", &m_sPartMemBlock.s32MAJ_CORR_INTERVAL,		 			120, 0, 1000),
