...
static PF_CombTempParam_t m_sTemperatureParam = { 0xFF}; // Simulate a flash memory

static PF_MotorOpeningsParam_t m_sPrimaryMotorParam = { 0xFF};

static PF_MotorOpeningsParam_t m_sGrillMotorParam = { 0xFF};
