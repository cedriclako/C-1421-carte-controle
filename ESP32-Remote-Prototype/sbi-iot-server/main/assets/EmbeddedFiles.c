...
/*! @brief Total size: 495238, total (including trailing 0s): 495253 */
const EF_SFile EF_g_sFiles[EF_EFILE_COUNT] = 
{
   ...
   [EF_EFILE_JS_VUE_MIN_JS] = { "js/vue.min.js", 107155, EF_EFLAGS_None, &EF_g_u8Blobs[36588], NULL },/* size: 107155 */
   [EF_EFILE_FAVICON_ICO] = { "favicon.ico", 1673, EF_EFLAGS_None, &EF_g_u8Blobs[143744], NULL },/* size: 1673 */
   [EF_EFILE_IMG_LOGO_SBI_350X256_PNG] = { "img/logo-sbi-350x256.png", 14236, EF_EFLAGS_None, &EF_g_u8Blobs[145418], &EF_g_sIMAGES_IMG_LOGO_SBI_350X256_PNG },/* size: 14236 */
   [EF_EFILE_FONT_ROBOTO_BOLD_TTF] = { "font/Roboto-Bold.ttf", 167336, EF_EFLAGS_None, &EF_g_u8Blobs[159655], NULL },/* size: 167336 */
   [EF_EFILE_FONT_ROBOTO_REGULAR_TTF] = { "font/Roboto-Regular.ttf", 168260, EF_EFLAGS_None, &EF_g_u8Blobs[326992], NULL }/* size: 168260 */
};

const uint32_t EF_g_u32BlobSize = 495253;
const uint32_t EF_g_u32BlobCRC32 = 2201049045;
