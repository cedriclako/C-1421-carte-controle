...
const EF_SImage EF_g_sIMAGES_ICON_ARROW_DOWN_120X60_JPG          = { .s32Width = 120, .s32Height = 60};
const EF_SImage EF_g_sIMAGES_ICON_ARROW_UP_120X60_JPG            = { .s32Width = 120, .s32Height = 60};
...
/*! @brief Total size: 36017, total (including trailing 0s): 36026 */
const EF_SFile EF_g_sFiles[EF_EFILE_COUNT] = 
{
   ...
   [EF_EFILE_ICON_ARROW_DOWN_120X60_JPG] = { "icon-arrow-down_120x60.jpg", 2442, EF_EFLAGS_None, &EF_g_u8Blobs[16200], &EF_g_sIMAGES_ICON_ARROW_DOWN_120X60_JPG },/* size: 2442 */
   [EF_EFILE_ICON_ARROW_UP_120X60_JPG] = { "icon-arrow-up_120x60.jpg", 2347, EF_EFLAGS_None, &EF_g_u8Blobs[18643], &EF_g_sIMAGES_ICON_ARROW_UP_120X60_JPG },/* size: 2347 */
   [EF_EFILE_ICON_SBI_LOGO_152X112_JPG] = { "icon-sbi-logo_152x112.jpg", 6923, EF_EFLAGS_None, &EF_g_u8Blobs[20991], &EF_g_sIMAGES_ICON_SBI_LOGO_152X112_JPG },/* size: 6923 */
   [EF_EFILE_ICON_SETTING_160X160_JPG] = { "icon-setting_160x160.jpg", 8110, EF_EFLAGS_None, &EF_g_u8Blobs[27915], &EF_g_sIMAGES_ICON_SETTING_160X160_JPG }/* size: 8110 */
};
