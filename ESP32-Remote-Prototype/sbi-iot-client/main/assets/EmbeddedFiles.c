...
/*! @brief Total size: 37803, total (including trailing 0s): 37814 */
const EF_SFile EF_g_sFiles[EF_EFILE_COUNT] = 
{
   ...
   [EF_EFILE_ICON_ARROW_DOWN_DISA_120X60_JPG] = { "icon-arrow-down_disa_120x60.jpg", 893, EF_EFLAGS_None, &EF_g_u8Blobs[16200], &EF_g_sIMAGES_ICON_ARROW_DOWN_DISA_120X60_JPG },/* size: 893 */
   [EF_EFILE_ICON_ARROW_DOWN_EN_120X60_JPG] = { "icon-arrow-down_en_120x60.jpg", 2442, EF_EFLAGS_None, &EF_g_u8Blobs[17094], &EF_g_sIMAGES_ICON_ARROW_DOWN_EN_120X60_JPG },/* size: 2442 */
   [EF_EFILE_ICON_ARROW_UP_DISA_120X60_JPG] = { "icon-arrow-up_disa_120x60.jpg", 893, EF_EFLAGS_None, &EF_g_u8Blobs[19537], &EF_g_sIMAGES_ICON_ARROW_UP_DISA_120X60_JPG },/* size: 893 */
   [EF_EFILE_ICON_ARROW_UP_EN_120X60_JPG] = { "icon-arrow-up_en_120x60.jpg", 2347, EF_EFLAGS_None, &EF_g_u8Blobs[20431], &EF_g_sIMAGES_ICON_ARROW_UP_EN_120X60_JPG },/* size: 2347 */
   [EF_EFILE_ICON_SBI_LOGO_152X112_JPG] = { "icon-sbi-logo_152x112.jpg", 6923, EF_EFLAGS_None, &EF_g_u8Blobs[22779], &EF_g_sIMAGES_ICON_SBI_LOGO_152X112_JPG },/* size: 6923 */
   [EF_EFILE_ICON_SETTING_160X160_JPG] = { "icon-setting_160x160.jpg", 8110, EF_EFLAGS_None, &EF_g_u8Blobs[29703], &EF_g_sIMAGES_ICON_SETTING_160X160_JPG }/* size: 8110 */
};
